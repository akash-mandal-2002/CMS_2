  ...
  return (
    <div className="">
      ...
      <div className="my-12 space-y-12 w-[90%] mx-auto p-4">
        ...
        <div className="bg-white shadow-2xl h-[48rem] md:h-[55rem] rounded-xl">
          <img
          ...
          <div className="flex items-center justify-center flex-col space-y-3 relative">
            ...
            <div className="flex mt-4 items-center justify-center p-2 w-[90%] md:w-[30%] border border-gray-300 md:justify-around rounded-md">
              <div className="flex items-center text-xs space-x-1 border-r p-1">
